...
detector.addEventListener("onImageResultsSuccess", function(faces, image, timestamp) {
  ...
  if (faces.length > 0) {
    ...
    // <your code here>
    updateGame(canvas,image,faces[0])
...
function drawEmoji(canvas, img, face) {
  ...
  // <your code here>
  var fp = face.featurePoints[10]
  ctx.strokeText(face.emojis.dominantEmoji, fp.x, fp.y);
}
...
function updateGame(canvas, img, face) {
  // console.log($("#target"))
  if (toUnicode(face.emojis.dominantEmoji) == targetCode) {
    console.log('mimic success!')
...
function initializeGame() {
  var rnd = Math.floor(Math.random()*emojis.length);
  targetCode = emojis[rnd];
  setTargetEmoji(targetCode);
  total += 1;
}
